...
import { getUsers, getUser, toggleBlockUser, deleteUser } from 'store/actions/user'
...
@connect(mapStateToProps, { getUser, getUsers, setToast, toggleBlockUser, deleteUser })
    ...
    return (
      <TableRow key={id} style={inlineStyles.row}>        
        ...
        <TableRowColumn colSpan="3" style={inlineStyles.rowColumn} >          
          ...
          <IconButton
            name="delete-button"
            onClick={e=>this._handleRemove(id, username)}
            disableTouchRipple
          >
            <ActionDelete/>
          </IconButton>
