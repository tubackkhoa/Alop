...
router.get('/', getPagingRouter(users, ['id','name','registered_at','username','phone','email','avatar','block','updated_at'], null, [['updated_at', 'DESC']]))
router.delete('/delete/:id', getDeleteRouter(users))
