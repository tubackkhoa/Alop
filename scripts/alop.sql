...
--
-- Host: localhost
-- Generation Time: Jun 29, 2017 at 05:18 AM
...
(3, 'admin@alop.vn', '$2a$10$Ek71SsHLO3BaWAgaJMYp2uLRHeyWQQI1mSDxjVu.o6mKA1jpYoaFm', 'Alop Admin', '4cc1c5c5-c3aa-4d8b-a7d8-658fe8e0968f.png', '{"entityMap":{},"blocks":[{"key":"80ukc","text":"Im a admin guy","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}}]}', '{"entityMap":{},"blocks":[{"key":"3g4iv","text":"Im a admin guy","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}}]}', '3.9391277acde40e7dbaa355f7586fae88b2a733758eb1acc789ef55274574d663adddfa2dddcdcb22', '2016-12-21 14:22:59', '2016-12-21 14:41:24');
...
(2, 'New title and changed more1', 'Mô tả ấn tượngTheo một nghiên cứu mới đây do Ford Việt Nam khảo sát, có tới 92% người Việt tự tin cho biết họ thành thục kĩ năng lái xe tiết kiệm nhiên liệu, nhưng thực tế ít người biết một số kiến thức cơ bản để có thể lái xe tiết kiệm hơn.', '<p>That is good</p>', '/uploads/news_post/image/2/3e18e274-9be3-4b1e-bf03-d8be41ad6d9a.png', '2016-12-17 03:16:16', '2016-12-17 03:16:17', 1),
(3, 'Nhiều người Việt chưa biết cách lái xe tiết kiệm nhiên liệu', 'Mô tả ấn tượngTheo một nghiên cứu mới đây do Ford Việt Nam khảo sát, có tới 92% người Việt tự tin cho biết họ thành thục kĩ năng lái xe tiết kiệm nhiên liệu, nhưng thực tế ít người biết một số kiến thức cơ bản để có thể lái xe tiết kiệm hơn.', '<p>Ngon phet</p>', '/uploads/news_post/image/3/eb8d8b7e-596a-43b3-b4da-cbbcdf413c98.png', '2016-12-17 03:17:12', '2016-12-17 03:17:12', 1);
...
INSERT INTO `sell_posts` (`id`, `title`, `description`, `phone`, `created_at`, `updated_at`, `user_id`, `image`, `type`, `user_type`) VALUES
(1, 'New title and changed more1', 'new post description', '1231312313', '0000-00-00 00:00:00', '2016-11-25 00:00:00', 1, '/uploads/sellpost/image/1/0263f30a-67a3-47dd-abde-f6857dce2035.png', 'sell', 'admin'),
(2, 'New title and changed more2', 'new post description', '1214149420', '0000-00-00 00:00:00', '2016-12-05 00:00:00', 1, '/uploads/sellpost/image/2/3065549b-1111-4e23-9686-9b970b01007c.png', 'transport', 'admin'),
(3, 'New title and changed more3', 'new post description', '1214149420', '2016-11-23 00:00:00', '2016-11-23 00:00:00', 0, 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAMgAAADICAYAAACtWK6eAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbW', 'sell', 'admin'),
(4, 'New title and changed more5', 'new post description', '1214149420', '2016-11-23 00:00:00', '2016-11-23 00:00:00', 0, 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAMgAAADICAYAAACtWK6eAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbW', 'sell', 'admin'),
(5, 'New title and changed more5', 'new post description', '1214149420', '2016-11-23 00:00:00', '2016-11-23 00:00:00', 0, 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAMgAAADICAYAAACtWK6eAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbW', 'sell', 'admin'),
(6, 'New title and changed more6', 'new post description', '1214149420', '2016-11-23 00:00:00', '2016-11-23 00:00:00', 0, 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAMgAAADICAYAAACtWK6eAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbW', 'sell', 'admin'),
(7, 'New title and changed more7', 'new post description', '1214149420', '2016-11-23 00:00:00', '2016-11-23 00:00:00', 0, 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAMgAAADICAYAAACtWK6eAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbW', 'sell', 'admin'),
(8, 'New title and changed more9', 'new post description', '1214149420', '2016-11-23 00:00:00', '2016-11-23 00:00:00', 0, 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAMgAAADICAYAAACtWK6eAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbW', 'sell', 'admin'),
(9, 'New title and changed more 9', 'new post description', '1214149420', '2016-11-23 00:00:00', '2016-11-23 00:00:00', 0, 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAMgAAADICAYAAACtWK6eAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbW', 'sell', 'admin'),
(11, 'New title and changed more11', 'new post description', '1214149420', '2016-11-23 00:00:00', '2016-11-23 00:00:00', 0, 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAMgAAADICAYAAACtWK6eAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbW', 'sell', 'admin'),
(12, 'Bài viết ấn tượng mới', 'Bài viết ấn tượng mới', '121212121212', '2016-12-13 00:00:00', '2016-12-13 00:00:00', 1, '/uploads/sellpost/image12/00d3fdb9-496d-40f0-9fad-219f744a433a.png', 'sell', 'admin'),
(13, 'New title and changed more1', 'new post description', '1231312313', '2016-12-13 00:00:00', '2016-12-13 00:00:00', 26, '', 'sell', 'user'),
(14, 'New title and changed more1', 'new post description', '1231312313', '2016-12-13 00:00:00', '2016-12-13 00:00:00', 26, '', 'sell', 'user'),
(15, 'New title and changed more1', 'new post description', '1231312313', '2016-12-13 00:00:00', '2016-12-13 00:00:00', 26, '', 'sell', 'user'),
(16, 'Nhiều người Việt chưa biết cách lái xe tiết kiệm nhiên liệu1', 'Mô tả ấn tượngTheo một nghiên cứu mới đây do Ford Việt Nam khảo sát, có tới 92% người Việt tự tin cho biết họ thành thục kĩ năng lái xe tiết kiệm nhiên liệu, nhưng thực tế ít người biết một số kiến thức cơ bản để có thể lái xe tiết kiệm hơn.', '1214149420', '2016-12-13 00:00:00', '2016-12-13 00:00:00', 1, '/uploads/sellpost/image/16/9e4efac7-1cc2-432a-a5b0-a6c4e56cda19.png', 'transport', 'admin'),
(17, 'Nhiều người Việt chưa biết cách lái xe tiết kiệm nhiên liệu', 'new post description', '1214149420', '2016-12-17 00:00:00', '2016-12-17 00:00:00', 1, '/uploads/sellpost/image/17/a601a1bd-697e-4390-8249-224419c00e86.png', 'sell', 'admin');
...
(1, 'Test 5', '2016-12-30 07:19:21', '2016-12-30 07:19:21'),
(2, 'Test 6', '2016-12-30 07:19:21', '2016-12-30 07:19:21'),
(3, 'Test 7', '2016-12-30 07:19:21', '2016-12-30 07:19:21'),
(4, 'Test 8', '2016-12-30 07:19:21', '2016-12-30 07:19:21'),
(5, 'Test 9', '2016-12-30 07:19:21', '2016-12-30 07:19:21'),
(6, 'Test 10', '2016-12-30 07:19:21', '2016-12-30 07:19:21'),
(7, 'Test 11', '2016-12-30 07:19:21', '2016-12-30 07:19:21'),
(8, 'Test 12', '2016-12-30 07:19:21', '2016-12-30 07:19:21'),
(9, 'Test 13', '2016-12-30 07:19:21', '2016-12-30 07:19:21'),
(10, 'Test 14', '2016-12-30 07:19:21', '2016-12-30 07:19:21'),
(11, 'Test 15', '2016-12-30 07:19:21', '2016-12-30 07:19:21'),
(12, 'Test 16', '2016-12-30 07:19:21', '2016-12-30 07:19:21'),
(13, 'Test 17', '2016-12-30 07:19:21', '2016-12-30 07:19:21'),
(14, 'Test 19', '2016-12-30 07:19:21', '2016-12-30 07:19:21'),
(15, 'Test 20', '2016-12-30 07:19:21', '2016-12-30 07:19:21'),
(16, 'Test 18', '2016-12-30 07:19:21', '2016-12-30 07:19:21'),
(17, 'Test 4', '2016-12-30 07:19:21', '2016-12-30 07:19:21'),
(18, 'Test 3', '2016-12-30 07:19:21', '2016-12-30 07:19:21'),
(19, 'Test 2', '2016-12-30 07:19:21', '2016-12-30 07:19:21'),
(20, 'Test 1', '2016-12-30 07:19:21', '2016-12-30 07:19:21');
...
INSERT INTO `users` (`id`, `email`, `phone`, `encrypted_password`, `login_type`, `username`, `avatar`, `registered_at`, `updated_at`, `name`, `block`, `user_type`) VALUES
(7, 'tupt@sinhvu.com', '', '', 'facebook', 'EAAS2N4DQMIEBADQHBUZAhTCgbfXSj3WXzIqlvBZAoKdLfDtbr', 'http://graph.facebook.com/1815104608743453/picture?type=large', '2016-11-25 10:59:59', '2016-11-26 08:11:38', 'Thanhtu Pham', 1, '1'),
...
(22, 'test123456@gmail.com', '0983758939', '$2a$10$ZR/ytZ.PRkyETu0474EjIuzYn3L2vF/iiALAP3oE98dhDs3.FDE66', 'local', 'test123456@gmail.com', '', '2016-12-13 15:44:02', '2016-12-13 15:44:02', 'Phạm Thanh Tú', 0, '1');
